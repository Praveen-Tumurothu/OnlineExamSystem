...
class AdminExamManagementTest {
	...
	@Test
	void testChangeTestPaperForStudent() throws Exception {
		Student s1 = new Student();
		s1.setStudentId(1);
		s1.setUsername("renu");
		s1.setPassword("hem@3458");
	...
	@Test
	void testFindAllResultsByBatchName() throws Exception  {
	...
	@Test
	void testFindResultByEnrollmentId() throws Exception {
	...
	@Test
	void testFindAllResultsByStudId() throws Exception {
		Student s1 = new Student();
		s1.setStudentId(1);
		s1.setUsername("renu");
		s1.setPassword("hem@3458");
	...
	@Test
	void testReleaseTestResultByEnrollmentId() throws Exception {
	...
	@Test
	void testReleaseAllTestResultForStudent() throws Exception {
		Student s1 = new Student();
		s1.setStudentId(1);
		s1.setUsername("renu");
		s1.setPassword("hem@3458");
